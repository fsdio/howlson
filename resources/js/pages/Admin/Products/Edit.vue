...
onMounted(() => {
    if (props.product.featured_image) {
        featuredImagePreview.value = `/storage/${props.product.featured_image}`;
    }
    
    if (props.product.gallery_images && props.product.gallery_images.length > 0) {
        existingGalleryImages.value = props.product.gallery_images.map(img => ({
            id: img.id,
                        ...
                        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div v-if="existingGalleryImages.length > 0" class="mb-4">
                                        <h4 class="text-sm font-medium text-gray-700 mb-2">Current Images</h4>
                                        <div class="grid grid-cols-2 gap-2">
                                            <div v-for="(image, index) in existingGalleryImages" :key="image.id" class="relative">
                                                <img :src="image.path" alt="Gallery image" class="w-full h-20 object-cover rounded" />
                                                <button
                                                    type="button"
                                    ...
                                    <div v-if="galleryPreviews.length > 0">
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            <div v-for="(preview, index) in galleryPreviews" :key="index" class="relative">
                                                <img :src="preview.preview" alt="Gallery image" class="w-full h-20 object-cover rounded" />
                                                <button
                                                    type="button"
